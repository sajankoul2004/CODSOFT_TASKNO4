...
import com.sajan.triviatrek.SpinWheel.LuckyWheelView;
import com.sajan.triviatrek.SpinWheel.model.LuckyItem;
import com.sajan.triviatrek.databinding.ActivitySpinnerBinding;
        ...
        database
                ...
                .update("coins", FieldValue.increment(cash)).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(SpinnerActivity.this, "Coins added into your wallet.", Toast.LENGTH_SHORT).show();
                        finish();
                    }
                });
    }
